...
//! the extracted code.
//!
//! A trait threads the needle. `crate::openhuman::memory::core_impl::Config` is the alias
...
pub trait MemoryHostConfig: Send + Sync + std::fmt::Debug {
    ...
    ///
    /// `crate::openhuman::memory::core_impl::Config` is the *unsized* `dyn MemoryHostConfig`, which
