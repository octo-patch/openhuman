...
//!
//! Same contract rules as [`crate::openhuman::tools::implementations::document::format::spec::document`] — `deny_unknown_fields`,
...
use crate::openhuman::tools::implementations::document::format::{Error, Result};
