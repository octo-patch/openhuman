...
//!    module is `serde` plus the crate [`Error`](crate::openhuman::tools::implementations::document::format::Error) — nothing else.
...
//! `crate::openhuman::tools::implementations::document::format::docx::DocumentSpec` and [`crate::openhuman::tools::implementations::document::format::spec::DocumentSpec`] name the
//! same type.
//!
//! [`crate::openhuman::tools::implementations::document::format::spec::DocumentSpec`]: DocumentSpec
